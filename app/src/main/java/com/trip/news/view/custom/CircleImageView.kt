...
class CircleImageView : AppCompatImageView {
    private var SCALE_TYPE = ScaleType.CENTER_CROP
        set(value) {
            field = value
            if (value != SCALE_TYPE) throw IllegalArgumentException(
                String.format(
    ...
    @Deprecated(
        ...
        ReplaceWith("setBorderColor(getContext().getResources().getColor(borderColorRes))")
    )
    ...
    @Deprecated(
        ...
        ReplaceWith("setFillColor(context.resources.getColor(fillColorRes))")
    )
